        ...
        <section className="dark:bg-(--c3) bg-(--c24) flex w-full">
              <div className='w-full'>
                <div className='p-8 rounded-xl border dark:border-(--c12) border-(--c25) bg-transparent w-full'>
                  <h1 className="text-4xl font-bold mb-[4%] dark:text-white text-(--c27) text-left cursor-default">Selecione até 3 sabor(es)</h1>

                  <div className='flex flex-wrap gap-[1.5rem] justify-center'>
                    <button onClick={()=>{selectFlavor("Mel de lavanda")}} disabled={customCart.flavors?.length >= 3 && !customCart.flavors?.includes("Mel de lavanda")} className={`${customCart.flavors?.includes("Mel de lavanda") ? 'bg-(--c12) text-white' : 'dark:bg-[rgba(0,0,0,0.5)] bg-[rgba(0,0,0,0.2)]'} ${customCart.flavors?.length >= 3 && !customCart.flavors?.includes("Mel de lavanda") && 'opacity-50 cursor-not-allowed'} border-1 dark:border-(--c12) border-(--c25) cursor-pointer dark:dark:text-white text-(--c27) text-(--c27) w-[45%] h-[2rem] 
                     rounded-md pl-[1rem] text-left font-medium transition duration-300`}>Mel de lavanda</button>

                    <button onClick={()=>{selectFlavor("Frutas vermelhas")}} disabled={customCart.flavors?.length >= 3 && !customCart.flavors?.includes("Frutas vermelhas")} className={`${customCart.flavors?.includes("Frutas vermelhas") ? 'bg-(--c12) text-white' : 'dark:bg-[rgba(0,0,0,0.5)] bg-[rgba(0,0,0,0.2)]'} ${customCart.flavors?.length >= 3 && !customCart.flavors?.includes("Frutas vermelhas") && 'opacity-50 cursor-not-allowed'} border-1 dark:border-(--c12) border-(--c25) cursor-pointer dark:text-white text-(--c27) w-[45%] h-[2rem] 
                     rounded-md pl-[1rem] text-left font-medium transition duration-300`}>Frutas vermelhas</button>

                    <button onClick={()=>{selectFlavor("Chá preto")}} disabled={customCart.flavors?.length >= 3 && !customCart.flavors?.includes("Chá preto")} className={`${customCart.flavors?.includes("Chá preto") ? 'bg-(--c12) text-white' : 'dark:bg-[rgba(0,0,0,0.5)] bg-[rgba(0,0,0,0.2)]'} ${customCart.flavors?.length >= 3 && !customCart.flavors?.includes("Chá preto") && 'opacity-50 cursor-not-allowed'} border-1 dark:border-(--c12) border-(--c25) cursor-pointer dark:text-white text-(--c27) w-[45%] h-[2rem] 
                     rounded-md pl-[1rem] text-left font-medium transition duration-300`}>Chá preto</button>

                    <button onClick={()=>{selectFlavor("Champanhe")}} disabled={customCart.flavors?.length >= 3 && !customCart.flavors?.includes("Champanhe")} className={`${customCart.flavors?.includes("Champanhe") ? 'bg-(--c12) text-white' : 'dark:bg-[rgba(0,0,0,0.5)] bg-[rgba(0,0,0,0.2)]'} ${customCart.flavors?.length >= 3 && !customCart.flavors?.includes("Champanhe") && 'opacity-50 cursor-not-allowed'} border-1 dark:border-(--c12) border-(--c25) cursor-pointer dark:text-white text-(--c27) w-[45%] h-[2rem] 
                     rounded-md pl-[1rem] text-left font-medium transition duration-300`}>Champanhe</button>

                    <button onClick={()=>{selectFlavor("Baunilha")}} disabled={customCart.flavors?.length >= 3 && !customCart.flavors?.includes("Baunilha")} className={`${customCart.flavors?.includes("Baunilha") ? 'bg-(--c12) text-white' : 'dark:bg-[rgba(0,0,0,0.5)] bg-[rgba(0,0,0,0.2)]'} ${customCart.flavors?.length >= 3 && !customCart.flavors?.includes("Baunilha") && 'opacity-50 cursor-not-allowed'} border-1 dark:border-(--c12) border-(--c25) cursor-pointer dark:text-white text-(--c27) w-[45%] h-[2rem] 
                     rounded-md pl-[1rem] text-left font-medium transition duration-300`}>Baunilha</button>

                    <button onClick={()=>{selectFlavor("Licor alcoólico")}} disabled={customCart.flavors?.length >= 3 && !customCart.flavors?.includes("Licor alcoólico")} className={`${customCart.flavors?.includes("Licor alcoólico") ? 'bg-(--c12) text-white' : 'dark:bg-[rgba(0,0,0,0.5)] bg-[rgba(0,0,0,0.2)]'} ${customCart.flavors?.length >= 3 && !customCart.flavors?.includes("Licor alcoólico") && 'opacity-50 cursor-not-allowed'} border-1 dark:border-(--c12) border-(--c25) cursor-pointer dark:text-white text-(--c27) w-[45%] h-[2rem] 
                     rounded-md pl-[1rem] text-left font-medium transition duration-300`}>Licor alcoólico</button>

                    <button onClick={()=>{selectFlavor("Pistache")}} disabled={customCart.flavors?.length >= 3 && !customCart.flavors?.includes("Pistache")} className={`${customCart.flavors?.includes("Pistache") ? 'bg-(--c12) text-white' : 'dark:bg-[rgba(0,0,0,0.5)] bg-[rgba(0,0,0,0.2)]'} ${customCart.flavors?.length >= 3 && !customCart.flavors?.includes("Pistache") && 'opacity-50 cursor-not-allowed'} border-1 dark:border-(--c12) border-(--c25) cursor-pointer dark:text-white text-(--c27) w-[45%] h-[2rem] 
                     rounded-md pl-[1rem] text-left font-medium transition duration-300`}>Pistache</button>

                    <button onClick={()=>{selectFlavor("Caramelo salgado")}} disabled={customCart.flavors?.length >= 3 && !customCart.flavors?.includes("Caramelo salgado")} className={`${customCart.flavors?.includes("Caramelo salgado") ? 'bg-(--c12) text-white' : 'dark:bg-[rgba(0,0,0,0.5)] bg-[rgba(0,0,0,0.2)] border-1 border-(--c12)'} ${customCart.flavors?.length >= 3 && !customCart.flavors?.includes("Caramelo salgado") && 'opacity-50 cursor-not-allowed'} border-1 dark:border-(--c12) border-(--c25) cursor-pointer dark:text-white text-(--c27) w-[45%] h-[2rem] 
                     rounded-md pl-[1rem] text-left font-medium transition duration-300`}>Caramelo salgado</button>

                    <button onClick={()=>{selectFlavor("Chocolate branco")}} disabled={customCart.flavors?.length >= 3 && !customCart.flavors?.includes("Chocolate branco")} className={`${customCart.flavors?.includes("Chocolate branco") ? 'bg-(--c12) text-white' : 'dark:bg-[rgba(0,0,0,0.5)] bg-[rgba(0,0,0,0.2)]'} ${customCart.flavors?.length >= 3 && !customCart.flavors?.includes("Chocolate branco") && 'opacity-50 cursor-not-allowed'} border-1 dark:border-(--c12) border-(--c25) cursor-pointer dark:text-white text-(--c27) w-[45%] h-[2rem] 
                     rounded-md pl-[1rem] text-left font-medium transition duration-300`}>Chocolate branco</button>

                    <button onClick={()=>{selectFlavor("Chocolate amargo")}} disabled={customCart.flavors?.length >= 3 && !customCart.flavors?.includes("Chocolate amargo")} className={`${customCart.flavors?.includes("Chocolate amargo") ? 'bg-(--c12) text-white' : 'dark:bg-[rgba(0,0,0,0.5)] bg-[rgba(0,0,0,0.2)]'} ${customCart.flavors?.length >= 3 && !customCart.flavors?.includes("Chocolate amargo") && 'opacity-50 cursor-not-allowed'} border-1 dark:border-(--c12) border-(--c25) cursor-pointer dark:text-white text-(--c27) w-[45%] h-[2rem] 
                    ...
                    <div className="grid grid-cols-2 gap-[18rem]">
                        <p className="mt-[2%] text-sm dark:text-white text-(--c27) text-left cursor-default">
