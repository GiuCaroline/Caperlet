            ...
            <section className="bg-(--c3) p-15 flex w-[100%]">
              <div className='w-[50%]'>
                <div class="p-8 rounded-xl border border-(--c12) bg-transparent w-full">
                  <h1 class="text-4xl font-bold mb-[4%] text-white text-left cursor-default">Escolha até 2 cores</h1>

                  <div class="grid grid-cols-2 gap-6">
                    <div className='border-2 p-5 rounded-2xl bg-[rgba(53,41,22,0.2)] border-(--c12)
                    hover:scale-105 transition-all duration-300 cursor-pointer'>
                      <div
                        class="relative bg-[#8B00FF] h-[120px] rounded-2xl border-4 border-transparent"
                      ></div>
                    </div>
                    ...
                    hover:scale-105 transition-all duration-300 cursor-pointer'>
                      <div
                        class="relative bg-[#4EEDB2] h-[120px]
                        rounded-2xl"
                      >
                        <div
                    ...
                    hover:scale-105 transition-all duration-300 cursor-pointer'>
                      <div
                        class="relative bg-[#FFEB3B] h-[120px] rounded-2xl 
                    ...
                    hover:scale-105 transition-all duration-300 cursor-pointer'>
                      <div
                        class="relative bg-[#E91E63] h-[120px] rounded-2xl 
                        border-4 border-transparent"
                      ></div>
                    </div>
                  </div>
                ...
                <div className='p-8 rounded-xl border border-(--c12) bg-transparent w-full mt-5'>
                  <h1 class="text-4xl font-bold mb-[4%] text-white text-left cursor-default">Selecione até 2 detalhes</h1>

                  <div className='flex flex-wrap gap-[1.5rem] justify-center'>
                    <button className='cursor-pointer text-white w-[45%] bg-[rgba(0,0,0,0.5)]
                    ...
                    <button className='cursor-pointer text-(--c7) w-[45%] bg-(--c12)
              ...
              <div className='w-[50%] ml-[5%]'>
                <div class="p-8 rounded-xl border border-(--c12) bg-transparent w-full flex flex-col">
                  ...
                  <h2 className='text-white font-bold text-xl mt-[4%]'>Cor principal</h2>
                  <div
                    class="top-2 right-2 w-4 h-4 rounded-full bg-[#4EEDB2]"
                  ></div>

                  <h2 className='text-white font-bold text-xl mt-[4%]'>Detalhes</h2>
                  <p class="text-base text-(--c16) text-left cursor-default">
