              ...
              <div className='w-full flex flex-col items-center'>
                <div className="p-8 rounded-xl border dark:border-(--c12) border-(--c25) bg-transparent w-[45rem]">
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div onClick={()=>{selectColor("Roxo")}} className={`${(customCart.color || []).some(c => c.name === 'Roxo') ? 'dark:border-(--c7) border-(--c2) border-3' : 'dark:border-(--c12) border-(--c25) border-2'} p-5 rounded-2xl bg-[rgba(53,41,22,0.2)]
                    hover:scale-105 transition-all duration-300`}>
                      ...
                      >
                        <div
                          className={`${(customCart.color || []).some(c => c.name === 'Roxo') ? 'absolute top-2 right-2 w-4 h-4 rounded-full dark:bg-(--c7) bg-(--c2) border-4 dark:border-(--c12) border-(--c25)' : ''}`}
                        ></div>
                      </div>
                    </div>

                    <div onClick={()=>{selectColor("Verde")}} className={`${(customCart.color || []).some(c => c.name === 'Verde') ? 'dark:border-(--c7) border-(--c2) border-3' : 'dark:border-(--c12) border-(--c25) border-2'} p-5 rounded-2xl bg-[rgba(53,41,22,0.2)]
                    hover:scale-105 transition-all duration-300`}>
                      <div
                      ...
                      >
                        <div
                          className={`${(customCart.color || []).some(c => c.name === 'Verde') ? 'absolute top-2 right-2 w-4 h-4 rounded-full bg-(--c7) border-4 dark:border-(--c12) border-(--c25)' : ''}`}
                        ></div>
                      </div>
                    </div>

                    <div onClick={()=>{selectColor("Amarelo")}} className={`${(customCart.color || []).some(c => c.name === 'Amarelo') ? 'dark:border-(--c7) border-(--c2) border-3' : 'dark:border-(--c12) border-(--c25) border-2'} p-5 rounded-2xl bg-[rgba(53,41,22,0.2)]
                    hover:scale-105 transition-all duration-300`}>
                      <div
                      ...
                      >
                        <div
                          className={`${(customCart.color || []).some(c => c.name === 'Amarelo') ? 'absolute top-2 right-2 w-4 h-4 rounded-full dark:bg-(--c7) bg-(--c2) border-4 dark:border-(--c12) border-(--c25)' : ''}`}
                        ></div>
                      </div>
                    </div>

                    <div onClick={()=>{selectColor("Rosa")}} className={`${(customCart.color || []).some(c => c.name === 'Rosa') ? 'dark:border-(--c7) border-(--c2) border-3' : 'dark:border-(--c12) border-(--c25) border-2'} p-5 rounded-2xl bg-[rgba(53,41,22,0.2)]
                    hover:scale-105 transition-all duration-300`}>
                      <div
                      ...
                      >
                        <div
                          className={`${(customCart.color || []).some(c => c.name === 'Rosa') ? 'absolute top-2 right-2 w-4 h-4 rounded-full dark:bg-(--c7) bg-(--c2) border-4 dark:border-(--c12) border-(--c25)' : ''}`}
                        ></div>
                      </div>
                    </div>
                  </div>

                  <p className="mt-6 text-sm dark:text-white text-(--c27) text-left cursor-default">
